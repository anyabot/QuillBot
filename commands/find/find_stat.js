    ...
    async run(message, { text }) {
        ...
        request(link, function (err, resp, html) {
			...
			if(output) {
				...
				.setURL(link)
				.setTitle(unit)
				.addField("Class", nam + " (" + lv1v1[6] + " → " + lv99v1[0] + ")")
				.setThumbnail(img)
				.setColor('LIGHT_GREY')
				.addField("HP", lv1v1[8] + " → " + lv99v1[2], true)
				.addField("ATK", lv1v1[10] + " → " + lv99v1[4], true)
				.addField("DEF", lv1v1[12] + " → " + lv99v1[6], true)
				.addField("Range", ran, true)
				.addField("MR", lv1v1[14], true)
				.addField("Block", lv1v1[16], true)
				.addField("Max Cost", lv1v1[18], true)
				.addField("Min Cost", lv1v1[20], true)
			...
			if (($('.c2').find('td').length >= 6) && !chibi) {
				...
				if(output && $('.c2.numbers').find('td') >=5) {
					...
					.setURL(link)
					.setTitle(unit)
					.addField("Class", nam + " (" + lv1v1[2] + " → " + lv99v1[0] + ")")
					.setThumbnail(img)
					.setColor('RED')
					.addField("HP", lv1v1[4] + " → " + lv99v1[2], true)
					.addField("ATK", lv1v1[6] + " → " + lv99v1[4], true)
					.addField("DEF", lv1v1[8] + " → " + lv99v1[6], true)
					.addField("Range", ran, true)
					.addField("MR", lv1v1[10], true)
					.addField("Block", lv1v1[12], true)
					.addField("Max Cost", lv1v1[14], true)
					.addField("Min Cost", lv1v1[16], true)
					.addField("Affection Bonus", aff, true)
					pages.push(embed);
				}
			}
			output = $('tbody .c3.numbers').text();
			if(output) {
				let lv99v1 = lv1line(output);
